...
public class MapEditor extends JFrame implements IState, ActionListener {
	
	//UI constraints
	static final int GUI_POSX = 0;
	static final int GUI_POSY = 0;
	static final int GUI_WIDTH = 200;
	static final int GUI_HEIGHT = 775;
	...
	private void run( JFrame aFrame ) {
		...
		tileGuiPanel.setPreferredSize( new Dimension( 200, 700 ));
		tileGuiPanel.setMinimumSize( new Dimension( 200, 500 ));
		tileGuiPanel.setMaximumSize(new Dimension( 200, 500 ));
		...
		JPanel fileManagerPanel = new JPanel( new FlowLayout( FlowLayout.CENTER, 5, 10) );
		...
		fileManagerPanel.add(exitButton);
		//fileManagerPanel.setAlignmentY( Component.BOTTOM_ALIGNMENT );
		fileManagerPanel.setPreferredSize( new Dimension( 200, 100 ));
		fileManagerPanel.setMaximumSize( new Dimension( 200, 100 ));
		fileManagerPanel.setBorder( BorderFactory.createCompoundBorder( BorderFactory.createLineBorder(Color.black), BorderFactory.createEmptyBorder(15, 0, 0, 0 )));
	...
	public void actionPerformed(ActionEvent e) {
		...
		switch ( e.getActionCommand() ) {
			...
			//Generate map button was pressed
			case "generate":
